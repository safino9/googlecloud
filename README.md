`一个小白撸谷歌云300$搭建Trojan的全程记录，如果你也是小白，按文中步骤操作，你也可以的，希望能帮到大家。提醒：把文章全部阅读一遍再进行实操。有写的不恰当的地方欢迎斧正。全文用到的工具和命令下载：`https://sxcool1024.lanzous.com/b00zcgdgd<br>`正文中点击“回到顶部”四个字即可回到目录，点击目录也会跳到相应模块。`<br>
`2020年4月29日更新：增加模块八：谷歌云如何防止免费试用到期后被扣费`<br>
`2020年5月7日更新：增加模块九：谷歌云免费到期后如何不删除之前创建的项目继续免费试用`
...
* [八、连接搭建节点，实现科学上网](#八连接搭建节点实现科学上网)<br>
* [九、免费到期如何防止意外扣费](#九免费到期如何防止意外扣费)<br>
* [十、免费试用到期后不删除已创建项目继续免费使用](#十免费试用到期后继续使用)<br>
* [十一、福利](#十一福利)<br>
  * [vultr新户充10$送100$活动及vultr16个机房测速工具](#vultr新户充10送100活动)
# 一、申请谷歌云并创建防火墙规则
## 1、申请谷歌云
...
<br>[回到顶部](#readme)
* 输入我的域名sxcool1024.com，你自己输入你的域名，最后结果如图，复制红圈中的链接在浏览器打开，下载Trojan文件压缩包，如下图
...
<br>[回到顶部](#readme)
# 八、连接搭建节点，实现科学上网
支持Trojan协议的工具，电脑端有Trojan-Qt5（Win+Mac+Linux）、clash（Win+Mac），苹果手机可用shadowrocket，安卓手机可用Igniter。<br>
[Trojan-Qt5（Windows）设置教程](https://portal.shadowsocks.nz/knowledgebase/161/)<br>
...
[回到顶部](#readme)
# 十、免费试用到期后继续使用
很多伙伴在试用到期后，还想使用谷歌云的话，就得就重新再申请一个新的账号，再重新搭建一次服务，其实我们还可以继续使用我们已经搭建好的服务项目，我们只需要重新申请一个谷歌云账号，将新谷歌云账号的结算账号跟老谷歌云账号绑定到一起就可以了，接下来看详细步骤。
* 重新申请一个新的谷歌云账号，参考前边内容<br>
* 进入新申请的谷歌云账号，点击账号管理—>添加新成员，新成员处填写老的谷歌云账号的邮箱，角色选择Billing Account Administra，全部填写完成后点保存，为了方便后边识别，也可点击重命名结算账号，随便起一个方便你识别的名字，假如起一个名字叫“新结算账号”。<br>
![谷歌云](https://www.nsaimg.com/2020/05/07/9b6455f183c20.jpg "谷歌云")
![谷歌云](https://www.nsaimg.com/2020/05/07/aa64bc18f77d4.jpg "谷歌云")<br>
[回到顶部](#readme)<br>
* 登陆老的账号-点击结算，进入以后可以看到有多个结算账号，点击管理结算账号
![谷歌云](https://www.nsaimg.com/2020/05/07/6b1fcd899e3a8.jpg "谷歌云")<br>
[回到顶部](#readme)<br>
* 点击“我的结算账号”后边的“我的项目”，可以看见我的项目里面就是我们老谷歌云账户建立的所有项目，点击后面三个竖点–点击更改结算账号
* 选择我们的新结算账号，点击设置账号，这样我们就完成了给老谷歌云账号绑定新结算账号
![谷歌云](https://www.nsaimg.com/2020/05/07/e376e62d2bec3.png "谷歌云")<br>
[回到顶部](#readme)
***
# 十一、福利
## vultr新户充10$送100$活动
