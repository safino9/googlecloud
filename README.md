`一个小白撸谷歌云300$搭建Trojan的全程记录，如果你也是小白，按文中步骤操作，你也可以的。希望能帮到大家。有写的不恰当的地方欢迎斧正。全文用到的工具和命令下载：https://www.lanzous.com/s/sxcool1024。正文中点击“回到顶部”四个字即可回到目录，点击目录也会跳到相应模块。`
