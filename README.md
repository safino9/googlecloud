...
# 五、把域名解析到谷歌云服务器地址
## 把域名跟新的DNS解析商关联在一起
* 1、这里新的DNS解析商推荐用DNSPOD([官网](https://www.dnspod.cn))，这是一个提供免费域名解析的网站，请自行注册，注册完成后，进入控制台，找到DNS管理->我的域名，添加域名。添加完成后，点击域名，默认里边有两条记录。如下图
![域名解析](https://www.louimg.com/u/20200326/00292795.png "域名解析")
![域名解析](https://www.louimg.com/u/20200326/00201698.png "域名解析")
* 2、进入购买域名的网站godaddy，找到我的产品，点击DNS，找到域名服务器，点击更改，把DNSPOD的默认记录的记录值复制到godaddy的自定义域名服务器处。
![域名解析](https://www.louimg.com/u/20200326/00130082.png "域名解析")
![域名解析](https://www.louimg.com/u/20200326/00130180.png "域名解析")
## 把域名解析到谷歌云服务器
DNSPOD添加域名后，域名里默认有两条记录，我们还需手动添加另外两条记录，手动添加的两条记录的记录值就是谷歌云创建的实例的外部IP,如图所示
